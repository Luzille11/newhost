                            ...
                            <table id="datatablesSimple">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $stock; ?></td>
                                        <td>
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit<?= $idb; ?>">
                                                Edit
                                            </button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <br>
                                                        <br>
                                                        <button type="submit" class="btn btn-primary" name="hapusbarang">Ya</button>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <input type="text" name="namabarang" placeholder="Merk Barang" class="form-control" required>
                    <br>
                    <input type="text" name="deskripsi" placeholder="Jenis Barang" class="form-control" required>
                    <br>
