...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.php">Jalwis Store</a>
        <!-- Sidebar Toggle-->
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if ($status == 'Dipinjam') {
                                            echo '<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit' . $idk . '">
                                            Selesai
                                        </button>';
                                        } else {
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                                <div class="modal-body">
                                                    <h5>Apakah Barang Ini Sudah Selesai Dipinjam?</h5>
                                                    <br>
